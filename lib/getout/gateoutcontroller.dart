...
class GateoutController extends StateNotifier<List<ContainerModel>> {
  Timer? _timer;

  GateoutController() : super([]) {
...
// Provider
final homeProvider =
    StateNotifierProvider<GateoutController, List<ContainerModel>>((ref) {
  return GateoutController();
});
